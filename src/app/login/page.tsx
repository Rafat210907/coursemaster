        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl w-full items-center">
          ...
          >
            <h1 className="text-5xl font-bold text-white leading-tight">
              ...
              <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">THE VISION UI DASHBOARD</span>
            </h1>
            <p className="text-gray-300 text-lg">
              Welcome back to your learning journey. Access world-class courses and continue your educational growth.
            </p>
          </motion.div>
          ...
          >
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-semibold py-3 rounded-lg transition duration-300"
              >
                SIGN IN
              </motion.button>
            </form>
